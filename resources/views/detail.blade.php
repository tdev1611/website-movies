                            ...
                            <div class="film-poster col-md-9">
                                ...
                                <ul class="list-info-group">
                                    <li class="list-info-group-item"><span>Trạng Thái</span> : <span
                                            class="quality">{{ $movie->definition }}</span><span class="episode">{{ $movie->subtitles }}</span></li>
                        ...
                        @foreach ($category->movies as $movie)
                            <article class="thumb grid-item post-38498">
                                <div class="halim-item">
                                    <a class="halim-thumb" href="{{ route('movie.detail',$movie->slug) }}" title="Đại Thánh Vô Song">
                                        <figure><img class="lazy img-responsive"
                                                src="{{ url($movie->image) }}"
                                                alt="Đại Thánh Vô Song" title="Đại Thánh Vô Song"></figure>
                                        <span class="status">{{ $movie->definition }}</span><span class="episode"><i class="fa fa-play"
                                        ...
                                        <div class="halim-post-title-box">
                                            <div class="halim-post-title ">
                                                ...
                                                <p class="original_title">
                                                   ...
                                                   {{ \Illuminate\Support\Str::limit($movie->desc, 500, '...') }}
                                                </p>
